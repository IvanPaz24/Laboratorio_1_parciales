...
class Nivel_Dos(Nivel):
    def __init__(self, pantalla):
        ...
        #personaje
        posicion_inicial = (LARGO/2 -100,700)
        tamaño = (110, 120)
        velocidad = 15
        donde_mira = False
        ...
        # segunda_plataforma.colision_pared(mi_personaje)

        tercer_plataforma = Plataforma(1550,590,170,230)
        tercer_plataforma.crear_lados()
        # tercer_plataforma.colision_pared(mi_personaje)

        # cuarta_plataforma = Plataforma(1520, 645, 162, 45)
        # cuarta_plataforma.crear_lados()

        lista_plataforma = [mi_piso, segunda_plataforma, tercer_plataforma]#mi_piso, primer_plataforma, segunda_plataforma,
